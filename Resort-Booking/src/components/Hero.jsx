...
const Hero = () => {
  return (
    <div
      ...
      md:px-3 lg:px-24 xl:px-32 px-3 text-white bg-[url('src/assets/heroImage.png')] 
     bg-no-repeat bg-cover bg-center md:bg-cover h-screen "
    >
      <p className="bg-[#49B9FF]/50 px-3 py-1 rounded-full ">
        The Ultimate Hotel Expirience
      </p>
      <h1
        className="font-playfair text-2xl md:text-5xl md:text-[56px]
       md:leading-[56px] font-bold md:font-extrabold max-w-xl mt-4"
      >
        Discover Your Perfact Gateway Destination
      </h1>
      <p className="text-sm md:text-base mt-2 max-w-130">
        Unparelled luxuary and comfort await at the world's most exclusive
        hotels and Resorts. Stay your Journey today.
      </p>
