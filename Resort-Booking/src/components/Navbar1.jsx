  ...
  return (
    <nav
      className={`fixed top-0 left-0 w-full flex 
        items-center justify-between px-4 md:px-16 lg:px-24 xl:px-32 transition-all duration-500 z-50 ${
          isScrolled
    ...
    >
      ...
      <Link to="/" className="flex items-center gap-2">
        <img
          src={
            assets.logo // Replace with your logo path
          }
          alt="logo"
      ...
      <div className="hidden md:flex items-center gap-4">
        ...
        {user ? (
          ...
          <button
            onClick={openSignIn}
            className={`bg-black px-8 py-2.5 rounded-full ml-4 transition-all duration-500 ${
      ...
      <div className="flex items-center gap-3 md:hidden">
        ...
        <img
          ...
          src={assets.menuIcon}
          alt="search"
          className={`h-6 w-4 text-white transition-all duration-500 ${
            isScrolled ? "invert" : ""
          }`}
        ></img>
      </div>
